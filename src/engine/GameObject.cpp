...
// <summary>
// Creates a new child game object with default parameters.
...
// </summary>
// <pparamname=" childInde">x An unsigned int representing the index of the child game object to be deleted </param>
...
// <summary>
// Removes a child game object from the children list.
// This function removes the given game object from the children list of the current game object.
// It does not destroy the child game object.
// </summary>
// <param name="pChild"> A pointer to the game object to be removed from the children list. </param>
