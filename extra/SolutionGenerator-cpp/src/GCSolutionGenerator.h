...
public:
	...
	static void CreateJSONProject(const std::string& fileName, std::string ProjectName);
	...
	static void EnsureJsonFileExists(const std::string& solutionFileName, const std::string& projectFileName, const std::string& projectName, const std::string& solutionName);
private:
